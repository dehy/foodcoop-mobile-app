...
export class AddSessionAttachment1592642586405 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "attachment" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" text NOT NULL, "path" text NOT NULL, "type" text NOT NULL, "goodsReceiptSessionId" integer)`,
            undefined,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `INSERT INTO "temporary_attachment"("id", "name", "path", "type", "goodsReceiptSessionId") SELECT "id", "name", "path", "type", "goodsReceiptSessionId" FROM "attachment"`,
            undefined,
        );
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `INSERT INTO "attachment"("id", "name", "path", "type", "goodsReceiptSessionId") SELECT "id", "name", "path", "type", "goodsReceiptSessionId" FROM "temporary_attachment"`,
            undefined,
        );
