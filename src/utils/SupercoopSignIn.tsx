...
export default class SupercoopSignIn {
    ...
    config: AuthConfiguration = {
        issuer: 'https://auth.supercoop.fr',
        clientId: 'hvejbWcEa6BZRJdA8dpQ81iW',
        redirectUrl: 'fr.supercoop.app://oauth',
        scopes: ['openid', 'profile', 'email'],
        usePKCE: true,
        useNonce: true,
    };

    // https://auth.supercoop.fr/oauth/jwks.json
    private static jwk = {
        alg: 'RS256',
        e: 'AQAB',
        kid: null,
